...
# -*- coding: utf-8 -*-
"""
Created on Sat Jan 26 13:51:21 2019
...
plt.title('The Trend of Every State\'s Opioids Percent')
plt.xlabel('Year')
plt.ylabel('The Percent of Opioids Reports')

y_ticks = np.arange(0, 0.501, 0.05)
plt.yticks(y_ticks)

plt.plot(years, everyYearOpioidsPercentInStates['OH'], 'c', label = 'OH')
plt.plot(years, everyYearOpioidsPercentInStates['KY'], 'r', label = 'KY')
plt.plot(years, everyYearOpioidsPercentInStates['WV'], 'b', label = 'WV')
plt.plot(years, everyYearOpioidsPercentInStates['VA'], 'g', label = 'VA')
plt.plot(years, everyYearOpioidsPercentInStates['PA'], 'k', label = 'PA')
...
plt.savefig("Every_State_Opioids_Percent_Trend.jpg", dpi = 300)
