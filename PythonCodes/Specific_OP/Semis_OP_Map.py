...
# -*- coding: utf-8 -*-
"""
Created on Mon Jan 28 01:55:52 2019
...
for opID in OP_Sort_Data['Semisynthetic opioids'].keys():
    for year in OP_Sort_Data['Semisynthetic opioids'][opID].keys():
        for stateID in OP_Sort_Data['Semisynthetic opioids'][opID][year].keys():
            for countyID in OP_Sort_Data['Semisynthetic opioids'][opID][year][stateID].keys():
                ...
                if str(countyLoc[stateID][countyID]['lat']) == '{}':
                    ...
                    Z[alreadyCounty.index(countyID)] += OP_Sort_Data['Semisynthetic opioids'][opID][year][stateID][countyID]
                else:
                    ...
                    Z.append(OP_Sort_Data['Semisynthetic opioids'][opID][year][stateID][countyID])
...
plt.title('The Number of 8-year Opioids Reports of Semisynthetic opioids')
...
plt.savefig('mapSemisynthetic_opioids.jpg', dpi=300)
