...
# -*- coding: utf-8 -*-
"""
Created on Mon Jan 28 01:29:32 2019
...
for opID in OP_Sort_Data['Opiates'].keys():
    for year in OP_Sort_Data['Opiates'][opID].keys():
        for stateID in OP_Sort_Data['Opiates'][opID][year].keys():
            for countyID in OP_Sort_Data['Opiates'][opID][year][stateID].keys():
                ...
                if str(countyLoc[stateID][countyID]['lat']) == '{}':
                    ...
                    Z[alreadyCounty.index(countyID)] += OP_Sort_Data['Opiates'][opID][year][stateID][countyID]
                else:
                    ...
                    Z.append(OP_Sort_Data['Opiates'][opID][year][stateID][countyID])
...
plt.title('The Number of 8-year Opioids Reports of Opiates')
...
plt.savefig('mapOpiates.jpg', dpi=300)
